...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-screen w-64 bg-white border-r border-gray-200 shadow-lg transition-transform duration-300 ease-in-out z-50 flex flex-col p-4 font-body ${isOpen ? 'translate-x-0' : '-translate-x-full'} overflow-hidden`}
      >
        {/* Close Button */}
        <button
